    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="px-6 py-16 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-gray-900 text-4xl font-bold mb-6">Servidores</h1>
          <p className="text-gray-600 text-lg max-w-3xl mb-16">
            Conheça os servidores que colaboram com nosso Observatório e contribuem para o combate à desinformação.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <img
                src="/imagens/Imagem do WhatsApp de 2025-04-20 à(s) 19.50.29_eaeb37f5.jpg"
                alt="Sheylene Alves de Oliveira"
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <img
                src="/imagens/Fabricio Rodrigues B. Neto.jpg"
                alt="Fabricio Rodrigues Bezerra"
                className="w-full h-[400px] object-cover group-hover:scale-105 transition duration-300"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6">

      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="px-6 py-16 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-gray-600 uppercase text-sm mb-4">CONHEÇA NOSSOS PROFESSORES</div>
            <h1 className="text-gray-900 text-4xl font-bold mb-6">Nossa Equipe</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <a
                  ...
                  aria-label="Currículo Lattes Wagner Mariano"
                >
              ...
              <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <img
                  ...
                  alt="Foto de Domenica Palomaris"
                  className="w-full h-[400px] object-cover group-hover:scale-105 transition duration-300"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="absolute bottom-4 right-4 bg-black/70 hover:bg-black/90 p-2 rounded-full transition"
                  aria-label="Currículo Lattes Domenica Palomaris"
                >
                  <FontAwesomeIcon icon={faLink} className="text-white" />
                </a>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="absolute bottom-4 right-4 bg-black/70 hover:bg-black/90 p-2 rounded-full transition"
                  aria-label="Currículo Lattes Elizângela Melo"
                >
                  <FontAwesomeIcon icon={faLink} className="text-white" />
                </a>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="absolute bottom-4 right-4 bg-black/70 hover:bg-black/90 p-2 rounded-full transition"
                  aria-label="Currículo Lattes Ana Cristina Mendanha Sampaio"
                >
                  <FontAwesomeIcon icon={faLink} className="text-white" />
                </a>
              </div>
